...
from common_tool import convert_single_example, InputExample
from task import preprocess_txt, DataProcessor
...
def restore_model(model_path):
    with tf.Session() as sess:
        ...
        case = convert_single_example(case, DataProcessor.get_labels())
        input = {
